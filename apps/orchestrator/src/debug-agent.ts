...
function buildSingleTurnSystemPrompt(): string {
  return [
    ...
    "- watch_email_reply: register a reply watcher after sending when the task requires waiting for a reply.",
...
function buildLoopSystemPrompt(): string {
  return [
    ...
    "- watch_email_reply: register a watcher after sending when you must resume later when a reply arrives.",
